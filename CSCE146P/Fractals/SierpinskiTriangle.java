...
public class SierpinskiTriangle extends Applet {
  ...
  private static boolean draworfill = draw; //Change to draw or fill if you want to draw or fill the polygons
  ...
  public void init() {
    ...
    drawTriangle(startX1, startY1, startX2, startY2, startX3, startY3, drawingArea,iter);
    insideTriangles(startX1, startY1, startX2, startY2, startX3, startY3, drawingArea,iter);
    //insideTriangles(0,height-1,width/2,0,width-1,height-1,drawingArea);
