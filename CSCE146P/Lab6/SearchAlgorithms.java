...
public class SearchAlgorithms {
  // I'm only writing these for Arrays, I find it easier to get values as a list, and turn into an array
  // As far as complexity I don't know how efficient this is, but considering the conversion is O(n)
  // And every retrieval from a linked list or other form is O(n) vs an array which is O(1)
  // Plus I think it'd be too much work to write this for lists or queues etc.
