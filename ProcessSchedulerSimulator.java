...
public class ProcessSchedulerSimulator {
	...
	public static final int MAX_SIM_TIME = 100;//Max cycle times
	...
	public static final int RAND_CANCEL_VAL = 25;//A value that ends the current process only it's a multiple.
